...
export const metadata: Metadata = { title: "Bautizos" };

export default function Page() {
  return (
    <div className="min-h-screen pt-20 flex items-center justify-center bg-cream/30">
      <div className="text-center">
        <p className="kicker text-dusky-rose">Bautizos</p>
        <h1 className="font-fraunces text-4xl mt-3 text-ink">Bautizos</h1>
